...
class Video extends Audio
{
	...
	$this->registerOption(new OptionType\Enum($this->translator->trans('Audio Codec'), self::OPTION_ACODEC, ['libfaac', 'libfdk_aac', 'libvo_aacenc', 'libmp3lame', 'libvorbis', 'aac'], 'libfaac'));
    }
